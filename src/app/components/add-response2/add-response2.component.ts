...
@Component({
  selector: 'app-add-response2',
  templateUrl: './add-response2.component.html',
  styleUrls: ['./add-response2.component.css']
})
export class AddResponse2Component implements OnInit {
  form: Form = new Form();
  formForm!: FormGroup;
  submitted = false;
  ...
  saveForm(): void {
    ...
    this.form.question = "On a scale of 1 to 10, how likely are you to recommend us to a friend or colleague?";
